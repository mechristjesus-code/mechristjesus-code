  ...
  return (
    <div className="page-shell flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[46%] flex-col justify-between p-12" style={{ background: 'var(--brand)', color: '#fff' }}>
        ...
        <div>
          <blockquote className="text-2xl font-semibold leading-snug mb-6 opacity-95">
            &ldquo;The only task manager that actually feels like it was built for developers.&rdquo;
          </blockquote>
          <p className="text-sm opacity-70">— Alex M., Product Manager</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8" style={{ color: 'var(--text-2)' }}>Sign in to your account to continue.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="••••••••" className="input-base pl-9" />
              </div>
            </div>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--text-2)' }}>
            No account?{' '}
            <Link href="/register" className="font-semibold" style={{ color: 'var(--brand)' }}>Create one free</Link>
          </p>
        </div>
      </div>
    </div>
